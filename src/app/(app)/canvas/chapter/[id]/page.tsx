  ...
  return (
    <div className="min-h-screen bg-bg flex flex-col">
      ...
      <div className="flex-1 overflow-y-scroll pb-20 pt-4">
        <div
          className="mx-4 mb-4 rounded-3xl border border-accent/10 bg-plum/20
                        p-5 text-center"
        >
          <div
            className="mx-auto mb-3 flex h-12 w-12 items-center justify-center rounded-full
                          border border-accent/20 bg-plum/40"
          >
            <Lock size={20} className="text-accent" />
          </div>
          <p className="mb-1 font-serif text-xl italic text-ink">
                ...
                <div className="flex items-center gap-2 p-3">
                  <div
                    className="flex h-5 w-5 items-center justify-center rounded-full border
                                  border-accent/20 bg-accent/20 text-[9px] font-medium text-accent"
                  >
