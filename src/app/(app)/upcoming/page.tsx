...
export default function UpcomingPage() {
  ...
  return (
    <div className="pb-28">
      ...
      <section className="mb-3 mt-8 flex items-center justify-between px-4">
        <div>
          <p className="text-sm font-medium text-ink">Time capsules</p>
          <p className="mt-0.5 text-xs text-muted">Things sealed for later</p>
        </div>
        <Link
          href="/capsule/new"
          className="flex items-center gap-1.5 rounded-full border border-border bg-surface2
                     px-3 py-1.5 text-xs font-medium text-accent transition-transform active:scale-95"
        >
          <Plus size={12} />
          New
        </Link>
